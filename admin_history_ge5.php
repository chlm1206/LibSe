...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Admin Reservation 5floor History Page</title>
    </head>
                ...
                <section>
                    <div id="size">
                        <table id="admin_history">
                            ...
                            <?php
                            // 오늘 5층 예약한 사람 정보 출력
                            $sqll = "select ge_num, gere_date, gere_stime, gere_etime, user_id, user_name from gereservation where ge_id=5 and gere_date='".$date."'";
