...
<html>
    <head>
       ...
       <meta name="viewport" content="width=800">
        <meta charset="utf-8">
        <title>Admin Reservation 6floor History Page</title>
    </head>
                ...
                <section>
                    <div id="size">
                        <table id="admin_history">
                            ...
                            <?php
                            // 오늘 6층 예약한 사람 정보 출력
                            $sqll = "select ge_num, gere_date, gere_stime, gere_etime, user_id, user_name from gereservation where ge_id=6 and gere_date='".$date."'";
