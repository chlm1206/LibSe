...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Admin Reservation 3floor History Page</title>
    </head>
    
    <body>
        <div>
            <header>
                <a href="admin_room_general.php">
                    <div>
                        <div id="admin_title">&lt; i-창작실</div>
                ...
                <section>
                    <div id="size">
                        <table id="admin_history">
                            ...
                            <?php
                            // 오늘 i-창작실 예약한 사람 정보 출력
                            $sqll = "select ge_num, gere_date, gere_stime, gere_etime, user_id, user_name from gereservation where ge_id=3 and gere_date='".$date."'";
