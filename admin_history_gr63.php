...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Admin Reservation 6-3 History Page</title>
    </head>
                ...
                <section>
                    <div id="size">
                        <table id="admin_history">
                            ...
                            $sqll = "select gr_name, grre_date, grre_stime, grre_etime, user_id, user_name from grreservation where gr_id=63 and grre_date='".$date."'";
