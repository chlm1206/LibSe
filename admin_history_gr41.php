...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Admin Reservation 4-1 History Page</title>
    </head>
                ...
                <section>
                    <div id="size">
                        <table id="admin_history">
                            ...
                            <?php
                            // 그룹스터디룸 오늘 예약한 사람 정보 출력
                            $sqll = "select gr_name, grre_date, grre_stime, grre_etime, user_id, user_name from grreservation where gr_id=41 and grre_date='".$date."'";
