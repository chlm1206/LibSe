...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Admin Reservation 4-3 History Page</title>
    </head>
    
    <body>
        <div>
            <header>
                <a href="admin_room_group.php">
                    <div>
                        <div id="admin_title">&lt; 4-3</div>
                ...
                <section>
                    <div id="size">
                        <table id="admin_history">
                            ...
                            <?php
                            // 오늘 그룹스터디룸 예약한 사람 정보 출력
                            $sqll = "select gr_name, grre_date, grre_stime, grre_etime, user_id, user_name from grreservation where gr_id=43 and grre_date='".$date."'";
