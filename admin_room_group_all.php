        ...
        <div>
            ...
            <main>
                <section>
                    <div id="size">
                        <table id="admin_home">
                            <tr onClick="location.href='admin_history_gr41_all.php'">
                                <div>
                            ...
                            <tr onClick="location.href='admin_history_gr42_all.php'">
                                <div>
                                    <td id="ad_detail" class="ad_line">
                            ...
                            <tr onClick="location.href='admin_history_gr43_all.php'">
                                <div>
                                    <td id="ad_detail" class="ad_line">
                            ...
                            <tr onClick="location.href='admin_history_gr61_all.php'">
                                <div>
                                    <td id="ad_detail" class="ad_line">
                            ...
                            <tr onClick="location.href='admin_history_gr62_all.php'">
                                <div>
                                    <td id="ad_detail" class="ad_line">
                            ...
                            <tr onClick="location.href='admin_history_gr63_all.php'">
                                <div>
                                    <td id="ad_detail" class="ad_line">
